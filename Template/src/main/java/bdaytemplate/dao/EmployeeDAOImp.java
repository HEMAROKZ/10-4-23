...
//        return getNamedParameterJdbcTemplate().query(SQL, new BeanPropertyRowMapper<>(EmailRequest.class));
//    }
//
//    @Override
...
//
//    @Override
//    public List<EmailRequest> findById(String employeeid) { // Changed to String
//        SqlParameterSource mapSqlParameterSource = new MapSqlParameterSource("employeeid", employeeid);
//        return getNamedParameterJdbcTemplate().query("SELECT * FROM details WHERE employeeid = :employeeid ", mapSqlParameterSource, new BeanPropertyRowMapper<>(EmailRequest.class));
//    }
}
